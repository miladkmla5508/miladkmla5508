...
- 🕵️‍♂️ I work with time-series data, including **EEG signals** ⚡ to analyze investors’ brain 🧠 functionality in decision-making, **traffic data** 🚦 to assess transportation and logistics 🚍 capacity, **Brokers’ multi-granularity OHLCV and limit order books** 📈, and **multi-layer on-chain metrics** ⛓️ to track whale 🐋 wallets activity in blockchain **.
